...
Docker, on Linux too; there the database must listen on more than
`127.0.0.1` and allow its user from the container's network; a PostgreSQL source adds database/slot/publication fields —
