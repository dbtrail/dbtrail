...
- **Keep a copy of this server's snapshots on this machine?** (#1681) — the
  ...
  `<state dir>/baselines/<server id>` (the state directory is the one holding
